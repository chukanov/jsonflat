...
import io.github.chukanov.jflat.schema.AutoSchemaFactory;
...
import io.github.chukanov.jflat.schema.converter.ToString;
...
public class ReadmeMdTest {
	...
	public void testDoc2() throws IOException {
		String schemaText = "{\n" +
				...
				"              \"fullname\": true,\n" +
				"              \"converter\": {\n" +
				"                \"class\": \"io.github..chukanov.jflat.schema.converter.ToString\"\n" +
				"              }\n" +
				"            }\n" +
				"          ]\n" +
				"        }\n" +
